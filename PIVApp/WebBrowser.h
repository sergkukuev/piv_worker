// WebBrowser.h: объ€вление классов-оболочек дл€ элементов управлени€ ActiveX, созданных при помощи Microsoft Visual C++
...
class WebBrowser : public CWnd
{
protected:
	DECLARE_DYNCREATE(WebBrowser)
public:
