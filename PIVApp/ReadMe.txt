...
PIVApp.h
    ...
    Он содержит прочие заголовки, относящиеся к проекту (включая Resource.h), а также объявляет класс приложения CPIVApp.

PIVApp.cpp
    Это основной исходный файл приложения, в котором содержится класс приложения CPIVApp.
...
PIVDlg.h, PIVDlg.cpp — диалоговое окно
    Эти файлы содержат класс CPIVDlg. Этот класс определяет поведение главного диалогового окна приложения. Шаблон диалогового окна находится в файле PIVApp.rc, который можно изменять с помощью Microsoft Visual C++.
